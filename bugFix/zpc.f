...
clin-8/2015:
cc                 write(92,200) ityp(i),px(i),py(i),pz(i),xmass(i),
cc     1           gx(i),gy(i),gz(i),ft(i),istrg0(i),xstrg0(i),ystrg0(i)
cc              else
clin-8/2015:
cc                 write(92,201) ityp(i),px(i),py(i),pz(i),xmass(i),
cc     1           gx(i),gy(i),gz(i),ft(i),istrg0(i),xstrg0(i),ystrg0(i)
c-tuo-prichard-2020
                 write(100,200) ityp(i),px(i),py(i),pz(i),xmass(i),
     1           gx(i),gy(i),gz(i),ft(i),istrg0(i),xstrg0(i),ystrg0(i)
              else

                 write(100,201) ityp(i),px(i),py(i),pz(i),xmass(i),
     1           gx(i),gy(i),gz(i),ft(i),istrg0(i),xstrg0(i),ystrg0(i)
              endif
...
c-tuo-prichard-2020
           if(ioscar.eq.2.or.ioscar.eq.3) CLOSE(100, STATUS='KEEP')
