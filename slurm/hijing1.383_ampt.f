...
cc tuos
cc           if(dmax1(abs(GX5(I)),abs(GY5(I)),abs(GZ5(I)),abs(FT5(I)))
cc     1          .lt.9999) then
cc              write(14,210) ITYP5(I), PX5(I), PY5(I), PZ5(I), XMASS5(I),
cc     1             GX5(I), GY5(I), GZ5(I), FT5(I)
cc           else
cc              write(14,211) ITYP5(I), PX5(I), PY5(I), PZ5(I), XMASS5(I),
cc     1             GX5(I), GY5(I), GZ5(I), FT5(I)
cc           endif
...
cc           write(94,243) YP(1,JP)+0.5*BB*cos(phiRP), 
cc     1 YP(2,JP)+0.5*BB*sin(phiRP),JP, NFP(JP,5),yp(3,jp),
cc     2 NFP(JP,3),NFP(JP,4)
cc        ENDDO
cc        DO JT=1,IHNT2(3)
...
cc           write(94,243) YT(1,JT)-0.5*BB*cos(phiRP), 
cc     1 YT(2,JT)-0.5*BB*sin(phiRP), -JT, NFT(JT,5),yt(3,jt),
cc     2 NFT(JT,3),NFT(JT,4)
cc        ENDDO
