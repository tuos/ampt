...
void flowAnalysisNewPtBin(){
     ...
     double minPtCut[NB_SLICE_PT] = {0.2,0.6,1.1,1.4,2.2,2.4,2.8,3.2,3.5,3.8,4.2,5.05,6.0,7.2,8.5};
     double maxPtCut[NB_SLICE_PT] = {0.6,1.1,1.4,2.2,2.4,2.8,3.2,3.5,3.8,4.2,5.05,6.0,7.2,8.5,1000}; //15 bins
     ...
     for(long ne=0; ne<nEvt; ne++)
     {
      ...
      ofstream output_v2;
      output_v2.open("output_v2_newptbins_Nch120150.txt");
      for(int i=0; i<NB_SLICE_PT; i++){     
