...
void flowAnalysis_threeTrees_nmult_vs_v2(){
     ...
     const int NB_SLICE_MULT = 21;
     double minMultCut[NB_SLICE_MULT] =  {0, 3, 6, 9, 12, 15, 18, 21, 25, 30, 35,40,45,50,70,90,110,130,150,170,190};
     double maxMultCut[NB_SLICE_MULT] = {3, 6, 9, 12, 15, 18, 21, 25,30,35,40,45,50,70,90,110,130,150,170,190,210}; //21 bins
