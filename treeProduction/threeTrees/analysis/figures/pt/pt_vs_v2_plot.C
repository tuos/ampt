...
////////
 ...
 hist->Draw();
  ...
  TGraphErrors *gr7 = new TGraphErrors(6,pbpbpt,pbpbv2,0,pbpbv2e);
  gr7->SetTitle("");
  ...
  TGraphErrors *gr8 = new TGraphErrors(6,ppbpt,ppbv2,0,ppbv2e);
  gr8->SetTitle("");
  ...
  gr8->Draw("psameez");
    ...
    TLegend *leg = new TLegend(0.66,0.68,0.95,0.95);
    leg->SetFillColor(10);
    leg->SetBorderSize(0);
    leg->SetTextFont(42);
    leg->SetTextColor(1);
    ...
    TLatex *tex2= new TLatex(0.25,0.40,"AMPT, #sqrt{s_{NN}} = 7.0 TeV");
    tex2->SetTextColor(1);
    tex2->SetTextSize(0.044);
    tex2->SetTextFont(42);
    tex2->Draw();
    TLatex *tex3= new TLatex(0.25,0.37,"#sigma = 3.0 mb");
    tex3->SetTextColor(1);
    tex3->SetTextSize(0.044);
    tex3->SetTextFont(42);
    tex3->Draw();
    TLatex *tex4= new TLatex(0.25,0.34,"N_{mult} #leq 200");
    tex4->SetTextColor(1);
    tex4->SetTextSize(0.044);
    tex4->SetTextFont(42);
    tex4->Draw();

    TLatex *tex5= new TLatex(2.77, 0.42, "(a)");
    tex5->SetTextColor(1);
