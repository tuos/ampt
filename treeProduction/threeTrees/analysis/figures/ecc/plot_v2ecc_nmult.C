...
*/
  ...
  ifstream ecc3;
  ifstream ecc4;
  ecc1.open("data/cc/v2eccPtP_output.txt");
  ecc2.open("data/cc/v2eccPnP_output.txt");
  ecc3.open("data/pc/v2eccPtP_output.txt");
  ecc4.open("data/pc/v2eccPnP_output.txt");
...
////////
 ...
 hist->SetYTitle("v_{2} / #varepsilon_{2}");
 hist->SetMinimum(-0.00499);
...
*/
    TLegend *leg = new TLegend(0.2,0.45,0.3,.6);
    leg->SetFillColor(10);
    leg->SetBorderSize(0);
    leg->SetTextFont(42);
    leg->SetTextColor(1);
    ...
    TLatex *tex2= new TLatex(20,0.042,"AMPT, #sqrt{s_{NN}} = 7.0 TeV");
    tex2->SetTextColor(1);
    tex2->SetTextSize(0.04);
    tex2->SetTextFont(42);
    tex2->Draw();
    TLatex *tex3= new TLatex(20,0.038,"#sigma = 3.0 mb");
    tex3->SetTextColor(1);
    tex3->SetTextSize(0.04);
    tex3->SetTextFont(42);
    tex3->Draw();
    TLatex *tex4= new TLatex(20,0.034,"0.3 < p_{T} [GeV/c] < 1000");
    tex4->SetTextColor(1);
  ...
  c1->Print("v2ecc_vs_mult.png");
  c1->Print("v2ecc_vs_mult.pdf");
